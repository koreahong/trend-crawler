...
#
# parser.add_argument(
#     "--start_date", "-s", required=True, help="시작일자를 입력받습니다. ex) 20211208"
# )
# parser.add_argument(
#     "--end_date", "-e", required=True, help="종료일자를 입력받습니다. ex) 20211208"
# )
#
# parser.add_argument(
#     "--gender",
...
device = "1_2"
device_list = [0, 0, 0]
for i in list(device.split('_')):
    device_list[int(i) // 10] += 1

gender = "1_2"
gender_list = [0, 0, 0]
for i in list(gender.split('_')):
    gender_list[int(i) // 10] += 1

age = "1_2"
age_list = [0, 0, 0, 0, 0, 0, 0]
for i in list(age.split('_')):
    age_list[int(i) // 10] += 1
...
data1 = pd.read_excel('./src/crawler_base/category_lv3.xlsx')
category_lv2 = data1[['category_1', 'category_1nm']].drop_duplicates('category_1', keep='first')
...
driver = webdriver.Chrome("./src/driver/chromedriver.exe")
...
"""
device 코드 예시
driver.find_element(by='xpath', value='//*[@id="18_device_0"]').click()
...
# 기기체크
for idx, i in enumerate(gender_list):
    if i == 1:
...
for idx, i in enumerate(gender_list):
    if i == 1:
        driver.find_element_by_xpath('//*[@id="19_gender_'
                                     ...
                                     + '"]').click()
# 연령체크
for idx, i in enumerate(age_list):
    if i == 1:
...
driver.find_element_by_xpath(
    '//*[@id="content"]/div[2]/div/div[1]/div/div/div[2]/div[2]/span[1]/div[1]/span'
).click()  # 연
# time.sleep(0.5)
driver.find_element_by_xpath(
    '//*[@id="content"]/div[2]/div/div[1]/div/div/div[2]/div[2]/span[1]/div[1]/ul/li[5]/a'
).click()  # 연 세부 2021년
# time.sleep(0.5)
driver.find_element_by_xpath(
    '//*[@id="content"]/div[2]/div/div[1]/div/div/div[2]/div[2]/span[1]/div[2]/span'
).click()  # 월
# time.sleep(0.5)
driver.find_element_by_xpath(
    '//*[@id="content"]/div[2]/div/div[1]/div/div/div[2]/div[2]/span[1]/div[2]/ul/li['
    + str(start_mm)
    + "]/a"
).click()  # 월 세부
# time.sleep(0.5)
driver.find_element_by_xpath(
    '//*[@id="content"]/div[2]/div/div[1]/div/div/div[2]/div[2]/span[1]/div[3]/span'
).click()  # 일
# time.sleep(0.5)
driver.find_element_by_xpath(
    '//*[@id="content"]/div[2]/div/div[1]/div/div/div[2]/div[2]/span[1]/div[3]/ul/li['
    + str(start_dd)
    + "]/a"
).click()  # 일 세부
...
driver.find_element_by_xpath(
    '//*[@id="content"]/div[2]/div/div[1]/div/div/div[2]/div[2]/span[3]/div[2]/span'
).click()  # 월
# time.sleep(0.5)
# driver.find_element_by_xpath('//*[@id="content"]/div[2]/div/div[1]/div/div/div[2]/div[2]/span[3]/div[2]/ul/li[5]/a').click() # 월 세부
driver.find_element_by_xpath(
    '//*[@id="content"]/div[2]/div/div[1]/div/div/div[2]/div[2]/span[3]/div[2]/ul/li['
    + str(end_mm)
    + "]/a"
).click()  # 월 세부
# time.sleep(0.5)
...
driver.find_element_by_xpath(
    '//*[@id="content"]/div[2]/div/div[1]/div/div/div[2]/div[2]/span[3]/div[3]/span'
).click()  # 일
# time.sleep(0.5)
driver.find_element_by_xpath(
    '//*[@id="content"]/div[2]/div/div[1]/div/div/div[2]/div[2]/span[3]/div[3]/ul/li['
    + str(end_dd)
    + "]/a"
).click()  # 일 세부
...
for j, cat2_row in tqdm(category_lv2.iterrows()):
    ...
    # time.sleep(0.1)
    category_1nm = category_lv2[category_lv2["category_2nm"] == category].iloc[0][
        "category_1nm"
    ]
...
new.rename(
    columns={
        ...
        "category_2nm_x": "ctgr_mclas_nm",
    },
    inplace=True,
)
new.to_csv(
    "/var/lib/airflow/workspace/tony/result/result_{todaydate}_{age}_{gender}_{s}_{e}.csv".format(
        todaydate=todaydate, age=age, gender=gender, s=end_date, e=start_date
    ),
    encoding="utf-8-sig",
    index=False,
)
...
# 기존 CSV 내보내기
keyword_df.to_csv(
    "/var/lib/airflow/workspace/tony/result/keyword_top100_{strt}_{end}.csv".format(
        strt=start_date, end=end_date
    ),
    index=False,
    encoding="utf-8-sig",
)
