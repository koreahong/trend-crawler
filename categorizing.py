...
#카테고리 수집 완료 후 카테고리 데이터 엑셀 파일로 내보내는 작업
...
updatet = str(mytime.tm_year)+ str(mytime.tm_mon) + str(mytime.tm_mday) 
#로컬용 저장경로
#category_lv3.to_excel('./category_lv4.xlsx', index=False)
#서버용 저장경로
category_lv3.to_excel('/var/lib/airflow/workspace/tony/src/category_lv3.xlsx', index=False)
driver.quit()